...
class ParallelCharts:
    ...
    def preprocess_data(self):
        ...
        self.teams = list(set(self.data_set_main['team']))
    ...
    def figures(self, data_sets: list[str], *teams_to_compare: list[str]) -> list[plotly.graph_objs.Figure]:
        ...
        for data_set_name in data_sets:
            ...
            graphs.append(
                dcc.Graph(
                    id=f'graph_{data_set_name}',
                    figure=self.figure(data_set_name, *teams_to_compare)
                    )
            )
        ...
        children=[
            html.Label("Graphs of Interest:"),
                ...
                dcc.Dropdown(
                    id='graph-dropdown',
                    multi=True,
                    options=self.data_sets,
                    value=self.data_sets[0]
                ),
            html.Br(),
            ], style={"textAlign": "float-left"}
        )
